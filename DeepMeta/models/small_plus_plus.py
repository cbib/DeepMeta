...
def small_plus_plus(input_shape, filters=16, drop_r=0.3):
    ...
    n2_1 = utils_model.block_up(
        c3, [c2], filters=filters, drop=drop_r, name="block_nested_3-1"
    )
    n2_2 = utils_model.block_up(
        n3_1, [n2_1, c2], filters=filters, drop=drop_r, name="block_nested_3-2"
    )
    u2 = utils_model.block_up(
        u3, [n2_2, n2_1, c2], filters=filters, drop=drop_r, name="block_up_3"
    )
